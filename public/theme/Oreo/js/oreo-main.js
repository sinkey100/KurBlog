/**
 * Created by lijianxiong on 8/11.
 */
...
$(function() {
    ...
    if(windowWidth < 480){
        ...
        $.event.add(window, "scroll", function () {
            ...
            if ((p) > startPos){
                $(elm).css({'position':'fixed','top':'0em','border-bottom':'1px solid #f1f3f5','margin-top':'-15px','height':'50px'});
            }else{
                $(elm).css({'position':'static','top':'','border-bottom':'','margin-top':'','height':''});
            }
        });
    }
